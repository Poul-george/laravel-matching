                ...
                <div class="mypage_form_div">
                    <div id="mypage_form_center" class="mypage_form_center">
                        ...
                        @if (session()->has('all_input_edit_session'))
                          @include('client1.issues.edit_issues_session')
                        @endif
                        ...
                        <div class="input_title_h3_div"><h3 class="input_title_h3">業務内容</h3></div>
                            ...
                            <div class="edit_form_div"> 
                                ...
                                <input id="" class="input_text max_input_text"  type="text" name="matter_name" value="{{$item2->matter_name}}" >
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea required id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea1">{{$item2->issue_info_textarea1}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea required id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea2">{{$item2->issue_info_textarea2}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea3">{{$item2->issue_info_textarea3}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea4">{{$item2->issue_info_textarea4}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                                    ...
                                    <div class="select_flex">
                                        <div class="cp_ipselect cp_sl01 select_3 ">
                                            <select required class="cp_sl06 money_width1" name="create_issues_select1" >
                                              @if (!isset($item2->basic_info_select1_1))
                                              ...
                                              @else
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                  @if($item2->basic_info_select1_1 == $i)
                                        ...
                                        <div class="cp_ipselect cp_sl01 select_3 ">
                                            <select required class="cp_sl06 money_width2" name="create_issues_select2" >
                                              @if (!isset($item2->basic_info_select1_2))
                                                    <option value="" selected>選択</option>
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                    <option value="{{$i}}" >{{$i}}</option>
                                                @endfor
                                              @else
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                  @if($item2->basic_info_select1_2 == $i)
                                                    <option selected value="{{$i}}" >{{$i}}</option>
                                                  @endif
                                                  <option value="{{$i}}" >{{$i}}</option>
                                                @endfor
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 160H~200H" name="create_issues_text1" value="{{$item2->basic_info_text1}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) JR山手線　五反田駅 / 品川区西五反田" name="create_issues_text2" value="{{$item2->basic_info_text2}}" required>
                              </div>
                                  ...
                                  <div class="edit_form2_div_input">
                                      <div class="cp_ipselect cp_sl01 country_select ex_companies_half_slct">
                                          ...
                                          <select required class="cp_sl05" name="create_issues_select3" >
                                              @if (!isset($item2->basic_info_select2))
                                                    <option value="" selected>選択</option>
                                              ...
                                              @else
                                                @foreach ($contract_form_list as $key=>$value)
                                                  @if($item2->basic_info_select2 == $key)
                                                    <option selected value="{{$key}}">{{$value}}</option>
                                                  @endif
                                                  <option value="{{$key}}">{{$value}}</option>
                                                @endforeach
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 自社案件・請負案件" name="create_issues_text3" value="{{$item2->basic_info_text3}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 即日～3ヶ月更新" name="create_issues_text4" value="{{$item2->recruitment_info_text1}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 10:00 ～ 19:00　残業月10～20時間程度" name="create_issues_text5" value="{{$item2->recruitment_info_text2}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 180時間/月" name="create_issues_text6" value="{{$item2->recruitment_info_text3}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 1人" name="create_issues_text7" value="{{$item2->recruitment_info_text4}}" required>
                              </div>
                              ...
                              <div class="edit_form_div">
                                ...
                                <div class="edit_form2_div_input">
                                  <!-- name -->
                                  <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea5">{{$item2->recruitment_info_textarea1}}</textarea>
                                </div>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) ２回" name="create_issues_text8" value="{{$item2->recruitment_info_text5}}" required>
                              </div>

                              <div class="edit_form_div">
                                  <p class="questionnaire_input_p">備考</p>
                                  <input id="" class="input_text max_input_text"  type="text" name="create_issues_text9" value="{{$item2->recruitment_info_text6}}" placeholder="例) 正社員・契約社員採用の場合は選考回数は複数回となります。">
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 株式会社〇〇" name="create_issues_text10" value="{{$item2->company_info_text1}}" required>
                              </div>
                                  ...
                                  <div class="edit_form2_div_input">
                                      <div class="cp_ipselect cp_sl01 country_select ex_companies_half_slct">
                                          ...
                                          <select class="cp_sl05" name="create_issues_select4" >
                                              @if (!isset($item2->company_info_select1))
                                                    <option value="" selected>選択</option>
                                              ...
                                              @else
                                                @foreach ($dress_list as $key=>$value)
                                                  @if($item2->company_info_select1 == $key)
                                                    <option selected value="{{$key}}">{{$value}}</option>
                                                  @endif
                                                  <option value="{{$key}}">{{$value}}</option>
                                                @endforeach
                              ...
                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">平均年齢</p>
                                    <input class="input_text" type="text" placeholder="例) 20代後半" name="create_issues_text11" value="{{$item2->company_info_text2}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">プロジェクト人数</p>
                                    <input class="input_text" type="text" placeholder="例) 十数名" name="create_issues_text12" value="{{$item2->company_info_text3}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">所在地</p>
                                    <input class="input_text" type="text" placeholder="例) 東京都東京都品川区〇〇" name="create_issues_text13" value="{{$item2->company_info_text4}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">設立年</p>
                                    <input class="input_text" type="text" placeholder="例) 2010年10月10日" name="create_issues_text14" value="{{$item2->company_info_text5}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">代表者</p>
                                    <input class="input_text" type="text" placeholder="例) 大阪　太朗" name="create_issues_text15" value="{{$item2->company_info_text6}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">従業員数</p>
                                    <input class="input_text" type="text" placeholder="例) 20名" name="create_issues_text16" value="{{$item2->company_info_text7}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">資本金</p>
                                    <input class="input_text" type="text" placeholder="例) 2000万円" name="create_issues_text17" value="{{$item2->company_info_text8}}" >
                              </div>
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($matching_position))
                                                @foreach ($matching_position as $check)
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($matching_skill))
                                                @foreach ($matching_skill as $check)
                                                  <div class="hidden_div_one">
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($matching_industry))
                                                @foreach ($matching_industry as $check)
                                                  <div class="hidden_div_one">
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($matching_technology_prosess_sonota))
                                                @foreach ($matching_technology_prosess_sonota as $check)
                                                  <div class="hidden_div_one">
