<div class="input_title_h3_div"><h3 class="input_title_h3">業務内容</h3></div>
                            ...
                            <div class="edit_form_div"> 
                              <div class="questionnaire_input_p_flex">
                                ...
                                <input id="" class="input_text max_input_text"  type="text" name="matter_name" value="{{$session_test['matter_name']}}" >
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea required id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea1">{{$session_test['create_issues_textarea1']}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea required id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea2">{{$session_test['create_issues_textarea2']}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea3">{{$session_test['create_issues_textarea3']}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                              ...
                              <div class="edit_form2_div_input">
                                <!-- name -->
                                <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea4">{{$session_test['create_issues_textarea4']}}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="edit_form_div">
                                    ...
                                    <div class="select_flex">
                                        <div class="cp_ipselect cp_sl01 select_3 ">
                                            <select required class="cp_sl06 money_width1" name="create_issues_select1" >
                                              @if (!isset($session_test['create_issues_select1']))
                                              ...
                                              @else
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                  @if($session_test['create_issues_select1'] == $i)
                                        ...
                                        <div class="cp_ipselect cp_sl01 select_3 ">
                                            <select required class="cp_sl06 money_width2" name="create_issues_select2" >
                                              @if (!isset($session_test['create_issues_select2']))
                                                    <option value="" selected>選択</option>
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                    <option value="{{$i}}" >{{$i}}</option>
                                                @endfor
                                              @else
                                                @for ($i = 10; $i <= 200;$i+=5)
                                                  @if($session_test['create_issues_select2'] == $i)
                                                    <option selected value="{{$i}}" >{{$i}}</option>
                                                  @endif
                                                  <option value="{{$i}}" >{{$i}}</option>
                                                @endfor
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 160H~200H" name="create_issues_text1" value="{{$session_test['create_issues_text1']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) JR山手線　五反田駅 / 品川区西五反田" name="create_issues_text2" value="{{$session_test['create_issues_text2']}}" required>
                              </div>
                                  ...
                                  <div class="edit_form2_div_input">
                                      <div class="cp_ipselect cp_sl01 country_select ex_companies_half_slct">
                                          ...
                                          <select required class="cp_sl05" name="todouhuken" >
                                              @if (!isset($session_test['todouhuken']))
                                                    <option value="" selected>選択</option>
                                              ...
                                              @else
                                                @foreach ($todouhuken_list as $key=>$value)
                                                  @if($session_test['todouhuken'] == $key)
                                  ...
                                  <div class="edit_form2_div_input">
                                      <div class="cp_ipselect cp_sl01 country_select ex_companies_half_slct">
                                          ...
                                          <select required class="cp_sl05" name="create_issues_select3" >
                                              @if (!isset($session_test['create_issues_select3']))
                                                    <option value="" selected>選択</option>
                                              ...
                                              @else
                                                @foreach ($contract_form_list as $key=>$value)
                                                  @if($session_test['create_issues_select3'] == $key)
                                                    <option selected value="{{$key}}">{{$value}}</option>
                                                  @endif
                                                  <option value="{{$key}}">{{$value}}</option>
                                                @endforeach
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 自社案件・請負案件" name="create_issues_text3" value="{{$session_test['create_issues_text3']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 即日～3ヶ月更新" name="create_issues_text4" value="{{$session_test['create_issues_text4']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 10:00 ～ 19:00　残業月10～20時間程度" name="create_issues_text5" value="{{$session_test['create_issues_text5']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 180時間/月" name="create_issues_text6" value="{{$session_test['create_issues_text6']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 1人" name="create_issues_text7" value="{{$session_test['create_issues_text7']}}" required>
                              </div>
                              ...
                              <div class="edit_form_div">
                                ...
                                <div class="edit_form2_div_input">
                                  <!-- name -->
                                  <textarea id="" class="textarea_input ex_companies_textarea ex_companies_input_text  tokuhitu_textarea" name="create_issues_textarea5">{{$session_test['create_issues_textarea5']}}</textarea>
                                </div>
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) ２回" name="create_issues_text8" value="{{$session_test['create_issues_text8']}}" required>
                              </div>

                              <div class="edit_form_div">
                                  <p class="questionnaire_input_p">備考</p>
                                  <input id="" class="input_text max_input_text"  type="text" name="create_issues_text9" value="{{$session_test['create_issues_text9']}}" placeholder="例) 正社員・契約社員採用の場合は選考回数は複数回となります。">
                              </div>
                              ...
                              <div class="edit_form_div flex_input">
                                <div class="questionnaire_input_p_flex">
                                  ...
                                  <label class="questionnaire_input_label">必須</label>
                                    ...
                                    <input class="input_text" type="text" placeholder="例) 株式会社〇〇" name="create_issues_text10" value="{{$session_test['create_issues_text10']}}" required>
                              </div>
                                  ...
                                  <div class="edit_form2_div_input">
                                      <div class="cp_ipselect cp_sl01 country_select ex_companies_half_slct">
                                          ...
                                          <select class="cp_sl05" name="create_issues_select4" >
                                              @if (!isset($session_test['create_issues_select4']))
                                                    <option value="" selected>選択</option>
                                              ...
                                              @else
                                                @foreach ($dress_list as $key=>$value)
                                                  @if($session_test['create_issues_select4'] == $key)
                                                    <option selected value="{{$key}}">{{$value}}</option>
                                                  @endif
                                                  <option value="{{$key}}">{{$value}}</option>
                                                @endforeach
                              ...
                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">平均年齢</p>
                                    <input class="input_text" type="text" placeholder="例) 20代後半" name="create_issues_text11" value="{{$session_test['create_issues_text11']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">プロジェクト人数</p>
                                    <input class="input_text" type="text" placeholder="例) 十数名" name="create_issues_text12" value="{{$session_test['create_issues_text12']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">所在地</p>
                                    <input class="input_text" type="text" placeholder="例) 東京都東京都品川区〇〇" name="create_issues_text13" value="{{$session_test['create_issues_text13']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">設立年</p>
                                    <input class="input_text" type="text" placeholder="例) 2010年10月10日" name="create_issues_text14" value="{{$session_test['create_issues_text14']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">代表者</p>
                                    <input class="input_text" type="text" placeholder="例) 大阪　太朗" name="create_issues_text15" value="{{$session_test['create_issues_text15']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">従業員数</p>
                                    <input class="input_text" type="text" placeholder="例) 20名" name="create_issues_text16" value="{{$session_test['create_issues_text16']}}" >
                              </div>

                              <div class="edit_form_div flex_input">
                                <p class="questionnaire_input_p">資本金</p>
                                    <input class="input_text" type="text" placeholder="例) 2000万円" name="create_issues_text17" value="{{$session_test['create_issues_text17']}}" >
                              </div>
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($session_test["create_issues_checkbox1"]))
                                                @foreach ($session_test['create_issues_checkbox1'] as $check)
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($session_test["create_issues_checkbox2"]))
                                                @foreach ($session_test['create_issues_checkbox2'] as $check)
                                                  <div class="hidden_div_one">
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($session_test["create_issues_checkbox3"]))
                                                @foreach ($session_test['create_issues_checkbox3'] as $check)
                                                  <div class="hidden_div_one">
                                        ...
                                        <div class="edit_checkbox_plural_div">
                                          ...
                                          <div class="hidden_div">
                                              ...
                                              @if (!empty($session_test["create_issues_checkbox4"]))
                                                @foreach ($session_test['create_issues_checkbox4'] as $check)
                                                  <div class="hidden_div_one">
