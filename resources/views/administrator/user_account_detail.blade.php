              ...
              <div class="company_info_detail_div">
                <div class="input_title_h3_div confirmation_input_title_h3_div"><h3 class="input_title_h3">基本情報</h3></div>
                  ...
                  <div class="company_info_detail_one_flex">
                    <h4 class="company_info_detail_title_h4">人材ID</h4>
                    <p class="company_info_detail_p">{{$item->user_id}}</p>
                  </div>

                  <div class="company_info_detail_one_flex">
                    <h4 class="company_info_detail_title_h4">Email</h4>
                    <p class="company_info_detail_p">{{$item->user_mail}}</p>
                  </div>

                  <div class="company_info_detail_one_flex">
                    <h4 class="company_info_detail_title_h4">氏名</h4>
                    <p class="company_info_detail_p">{{$item->user_name}}</p>
                  </div>
            ...
            <div class="confirmation_input_div" >
              <div class="company_info_detail_div">
                <div class="input_title_h3_div confirmation_input_title_h3_div"><h3 class="input_title_h3">自己紹介</h3></div>
                  ...
                  <!-- 必須 -->
                  @if (isset($item->biography_works_file_1))
                  <div class="company_info_detail_one_flex">
