          ...
          <div class="company_info_detail_div">
            <div class="input_title_h3_div confirmation_input_title_h3_div"><h3 class="input_title_h3">基本情報</h3></div>
              ...
              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">会社名ID</h4>
                <p class="company_info_detail_p">{{$company_item->shop_id}}</p>
              </div>

              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">Email</h4>
                <p class="company_info_detail_p">{{$company_item->shop_mail}}</p>
              </div>

              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">会社名</h4>
                <p class="company_info_detail_p">{{$company_item->shop_name}}</p>
              </div>

              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">担当者名</h4>
                <p class="company_info_detail_p">{{$company_item->tantou_name}}</p>
              </div>

              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">担当者名(ひらがな)</h4>
                <p class="company_info_detail_p">{{$company_item->tantou_name_fri}}</p>
              </div>

              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">電話番号</h4>
                <p class="company_info_detail_p">{{$company_item->shop_phone}}</p>
              </div>
        ...
        <div class="confirmation_input_div">
          <div class="company_info_detail_div">
            <div class="input_title_h3_div confirmation_input_title_h3_div"><h3 class="input_title_h3">概要</h3></div>
              ...
              <div class="company_info_detail_one_flex">
                <h4 class="company_info_detail_title_h4">郵便番号</h4>
                <p class="company_info_detail_p">{{$company_item->address_number}}</p>
              </div>
